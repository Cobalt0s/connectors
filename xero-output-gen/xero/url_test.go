...
// TODO if construct URL method has no encoding exceptions this test is redundant and can be removed
func TestConstructURL(t *testing.T) {
	...
	tests := []struct {
		...
		/*
			TODO add your own test to validate Query Param construction
			{
				...
				expected:
					"https://test?starting_after=WzE3MTU2OTU2NzkwMDAsIjU3Y2NjMmU2LTEyODctNDEwZC1iMDI3LTVjOGU4NzIzMzU3YyIsMl0=",
			},
		*/
	}
